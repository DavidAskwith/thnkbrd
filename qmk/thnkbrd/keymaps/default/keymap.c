...
// ├───────┼───────┼───────┼───────┼───────┼───────┤   ├───────┼───────┼───────┼───────┼───────┼───────┤
// │Esc/GUI│ A/Shft│ S/L6  │  D/L4 │ F/L2  │G/Ctrl │   │ H/Ctrl│ J/L1  │ K/L3  │ L/L5  │;/Shift│   '   │
// ├───────┼───────┼───────┼───────┼───────┼───────┤   ├───────┼───────┼───────┼───────┼───────┼───────┤
// │ TG(7) │   Z   │   X   │   C   │   V   │   B   │   │   N   │   M   │   ,   │   .   │   /   │ TG(7) │
// ╰───────┴───────┴───────┼───────┼───────┼───────┤   ├───────┼───────┼───────┼───────┴───────┴───────╯
//                         │Ent/GUI│ Bkspc │TO(D0) │   │TD(D1) │GUI(-) │ Space │
//                         ╰───────┴───────┴───────╯   ╰───────┴───────┴───────╯
  [0] = LAYOUT(
    ...
    MT(MOD_LGUI, KC_ENTER), KC_BSPC, TD(DANCE_0),                                                        TD(DANCE_1), LGUI(KC_MINUS), KC_SPACE
  ),
// ╭───────┬───────┬───────┬───────┬───────┬───────╮   ╭───────┬───────┬───────┬───────┬───────┬───────╮
// │  ---  │  ---  │   =>  │   +   │   *   │   ^   │   │  ---  │  ---  │   C   │  ---  │  ---  │  ---  │
// ├───────┼───────┼───────┼───────┼───────┼───────┤   ├───────┼───────┼───────┼───────┼───────┼───────┤
...
//                         ╰───────┴───────┴───────╯   ╰───────┴───────┴───────╯
  [1] = LAYOUT(
    KC_TRNS, KC_TRNS, ST_MACRO_0, KC_PLUS, KC_ASTR, KC_CIRC,  KC_TRNS, KC_TRNS, KC_C, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_MINUS, KC_LABK, KC_LCBR, KC_LPRN, KC_LBRC,    KC_TRNS, KC_TRNS, KC_RIGHT_CTRL, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_RABK, KC_RCBR, KC_RPRN, KC_RBRC,     KC_TRNS, KC_TRNS, KC_D, KC_TRNS, KC_TRNS, KC_TRNS,
...
//                         ╰───────┴───────┴───────╯   ╰───────┴───────┴───────╯
  [3] = LAYOUT(
    ...
    KC_TRNS, KC_1, KC_2, LT(4, KC_3), KC_4, KC_5,          KC_TRNS, KC_RIGHT_GUI, KC_TRNS, KC_RIGHT_CTRL, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS,                             KC_TRNS, KC_TRNS, KC_RIGHT_SHIFT
  ),
// ╭───────┬───────┬───────┬───────┬───────┬───────╮   ╭───────┬───────┬───────┬───────┬───────┬───────╮
// │  ---  │  ---  │  ---  │  ---  │  ---  │  ---  │   │  ---  │  ---  │  ---  │  ---  │  ---  │  ---  │
// ├───────┼───────┼───────┼───────┼───────┼───────┤   ├───────┼───────┼───────┼───────┼───────┼───────┤
// │  ---  │  ---  │ LCTRL │  ---  │ LGUI  │  ---  │   │   6   │   7   │   8   │   9   │   0   │  ---  │
// ├───────┼───────┼───────┼───────┼───────┼───────┤   ├───────┼───────┼───────┼───────┼───────┼───────┤
// │  ---  │  ---  │  ---  │  ---  │  ---  │  ---  │   │  ---  │  ---  │  ---  │  ---  │  ---  │  ---  │
// ╰───────┴───────┴───────┼───────┼───────┼───────┤   ├───────┼───────┼───────┼───────┴───────┴───────╯
//                         │ LSFT  │  ---  │  ---  │   |  ---  │  ---  │  ---  │
//                         ╰───────┴───────┴───────╯   ╰───────┴───────┴───────╯
  [4] = LAYOUT(
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_RIGHT_CTRL, KC_TRNS, KC_LEFT_GUI, KC_TRNS,    KC_6, KC_7, LT(3,KC_8), KC_9, KC_0, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT_ALT, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_LEFT_SHIFT, KC_TRNS, KC_TRNS,                             KC_TRNS, KC_TRNS, KC_TRNS
  ),
...
//                         ╰───────┴───────┴───────╯   ╰───────┴───────┴───────╯
  [5] = LAYOUT(
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, LCTL(LSFT(KC_R)),KC_TAB, LSFT(KC_F6), KC_F4, LCTL(LSFT(KC_I)),   KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT_CTRL, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS,                                                KC_TRNS, KC_TRNS, KC_TRNS
  ),
...
void tap_layer_hold_key_finished(tap_dance_state_t *state, int layer, int key_code);

void tap_layer_hold_key_finished(tap_dance_state_t *state, int layer, int key_code) {
    dance_state = get_dance_state(state);
    switch (dance_state) {
        case TAP: layer_move(layer); break;
        case HOLD: register_code16(key_code); break;
    }
}
...
void tap_layer_hold_key_reset(tap_dance_state_t *state, int key_code) {
    wait_ms(10);
    switch (dance_state) {
        case HOLD: unregister_code16(key_code); break;
    }
    dance_state = 0;
}
...
tap_dance_action_t tap_dance_actions[] = {
        [DANCE_0] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, tap_8_hold_alt_finished, alt_hold_reset),
        [DANCE_1] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, tap_6_hold_alt_finished, alt_hold_reset),
};
